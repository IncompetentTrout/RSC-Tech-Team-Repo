...
public class CheckPoint : MonoBehaviour
{
    ...
    {
        GameObject.FindGameObjectWithTag("GameManager").GetComponent<SaveManager>().HitCheckPoint(gameObject); //calls the save-script to signify it has hit a checkpoint
