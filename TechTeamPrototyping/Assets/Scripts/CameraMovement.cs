...
public class CameraMovement : MonoBehaviour
{
    ...
    void Move()
    {
            ...
            Vector3 tarPos = new Vector3(target.transform.position.x + xOffset, target.transform.position.y + yOffset, target.transform.position.z);
            ...
            if (tarPos.x != pos.x || tarPos.y != pos.y)
            {
                ...
                gameObject.transform.position = new Vector3(pos.x + (xDifference * camSpeed * Time.deltaTime), pos.y + (yDifference * camSpeed * Time.deltaTime), pos.z);
            }
