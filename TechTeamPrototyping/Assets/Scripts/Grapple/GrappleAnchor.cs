...
public class GrappleAnchor : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider other) {
        if (other.tag == "Player" &&
            enteredPlayer ==
            null) //if the object that entered the area is a player and there isnt already a player inside the array
        {
            ...
            hook.EnterGrappleRadius(gameObject.transform
                .position); //calls a function in the grapplehook script and passes through the game object 
        }
    }
